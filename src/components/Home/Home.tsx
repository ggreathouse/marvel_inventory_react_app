...
import marvel_image from '../../assets/images/marvel-comics.jpg'
    ...
    return (
        <Root>
            ...
            <Main>
                <MainText>
                    <h1>{props.title}</h1>
                    <p>Superheroes Rule</p>
                    <Button color='primary' variant='contained' component = {Link} to='/dashboard'>See the Superheroes</Button>
                </MainText>
            </Main>
